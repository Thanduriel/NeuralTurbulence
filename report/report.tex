...
\begin{figure}
	...
	\begin{scope}[x={(image.south east)},y={(image.north west)}]
		\draw[blue,ultra thick,rounded corners] (0.0,0.419) rectangle (0.05,0.581);
		\draw[blue,ultra thick] (0.2,0.5) ellipse [x radius=0.05, y radius=0.1];
	\end{scope}
	\draw (-0.081*5,0.0) rectangle (0.081*5,0.1*5);
	\draw (0.0,0.25*5) circle [radius=0.1*5] (0.1*5,0.25*5) node[right] {obstacle};
	\draw (-0.081*5,0.0) rectangle (0.081*5,0.1*5) (0.081*5,0.05*5) node[right] {source};
	\end{tikzpicture}
	\caption{The Scene.}
	\label{trainingScene}
\end{figure}

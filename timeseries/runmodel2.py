...
print("Loading data.")
seed = 5281034
dataNames = [getDataSetName("fullout", 8, inputIsFrequency, outputIsFrequency, hasReducedOutput, 1282749)]
dataNames.append(getDataSetName("fullout", 8, inputIsFrequency, outputIsFrequency, hasReducedOutput, 5281034))
